      ...
      <Card border={showSectionErrors ? "danger" : "default"}>
        <Card.Body>
          ...
          <div className="comp-details-form">
            <p>Use this field to add critical contextual information not reported in the form above</p>
            ...
            >
              <label htmlFor="officer-supporting-notes-select-id">Officer</label>
              <div className="comp-details-input full-width">
                <CompSelect
